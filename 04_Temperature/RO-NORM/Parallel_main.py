...
def main(args):
    ...
    ################################################################
    optimizer = Adam(weight_model.parameters(), lr=learning_rate, weight_decay=1e-4) #torch.optim.Adam
    ...
    for ep in range(epochs):
        ...
        print('Step: %d, Train L2: %.5f, Test L2: %.5f, Emax_test: %.5f, Time: %.3fs'%(ep, train_l2, test_l2, ET_list[ep], T))
        time_step = time.perf_counter()
    ...
    for i in range(3):
        ...
        for args in [
                ...
                { 'modes': 32, 
                  ...
                  'batch_size': 50, 
                  'epochs': 500,
                  'data_dir': '../data/Qianyuan', 
                  'num_train': 500, 
                  'num_test': 100,
                  'casename': 'Qianyuan_'+str(i),
                   'BASIS':'POD',
                  'lr' : 0.01},
             ]:
